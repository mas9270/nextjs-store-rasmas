...
import AddEditProducts from "./_components/addEditProducts";
import DeleteProducts from "./_components/deleteProducts";
...
export default function ProductsPage() {
  ...
  const columns = [
    ...
    { field: "stock", headerName: "استوک", width: 100 },
    { field: "images", headerName: "عکس", width: 100 },
    { field: "description", headerName: "توضیحات", width: 300 },
    {
      field: "createdAt",
